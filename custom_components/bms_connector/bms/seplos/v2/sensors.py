...
async def generate_sensors(hass, bms_type, connector_info, config_battery_address, sensor_prefix, entry_id, async_add_entities):
    ...
    setting_sensors = [
        ...
        SeplosBMSSensorBase(coordinator, connector_info, "total_pressure_and_high_pressure_recovery", "Total Pressure and High Pressure Recovery", "V", "mdi:flash-circle", battery_address=battery_address, sensor_prefix=sensor_prefix, entry_id=entry_id, is_settings=True),
        ...
        SeplosBMSSensorBase(coordinator, connector_info, "total_pressure_and_low_pressure_recovery", "Total Pressure and Low Pressure Recovery", "V", "mdi:flash-circle", battery_address=battery_address, sensor_prefix=sensor_prefix, entry_id=entry_id, is_settings=True),
        ...
        SeplosBMSSensorBase(coordinator, connector_info, "ambient_low_temperature_warning", "Ambient Low Temperature Warning", "°C", "mdi:thermometer-alert", battery_address=battery_address, sensor_prefix=sensor_prefix, entry_id=entry_id, is_settings=True),
        ...
        SeplosBMSSensorBase(coordinator, connector_info, "fan_fault", "Fan Fault", "When", "mdi:fan", battery_address=battery_address, sensor_prefix=sensor_prefix, entry_id=entry_id, is_settings=True),
        SeplosBMSSensorBase(coordinator, connector_info, "fan_fault_recovery", "Fan Fault Recovery", "When", "mdi:fan", battery_address=battery_address, sensor_prefix=sensor_prefix, entry_id=entry_id, is_settings=True),
        SeplosBMSSensorBase(coordinator, connector_info, "can_communication_fault", "CAN Communication Fault", "When", "mdi:network", battery_address=battery_address, sensor_prefix=sensor_prefix, entry_id=entry_id, is_settings=True),
        SeplosBMSSensorBase(coordinator, connector_info, "can_communication_fault_recovery", "CAN Communication Fault Recovery", "When", "mdi:network", battery_address=battery_address, sensor_prefix=sensor_prefix, entry_id=entry_id, is_settings=True),
        SeplosBMSSensorBase(coordinator, connector_info, "mos_short_circuit_protection", "MOS Short Circuit Protection", "When", "mdi:flash-alert", battery_address=battery_address, sensor_prefix=sensor_prefix, entry_id=entry_id, is_settings=True),
        SeplosBMSSensorBase(coordinator, connector_info, "mos_short_circuit_protection_recovery", "MOS Short Circuit Protection Recovery", "When", "mdi:flash", battery_address=battery_address, sensor_prefix=sensor_prefix, entry_id=entry_id, is_settings=True),
        ...
        SeplosBMSSensorBase(coordinator, connector_info, "overcurrent_delay_recovery_times", "Overcurrent Delay Recovery Times", "times", "mdi:timer-sand", battery_address=battery_address, sensor_prefix=sensor_prefix, entry_id=entry_id, is_settings=True),
        ...
        SeplosBMSSensorBase(coordinator, connector_info, "compensation_point_3_position", "Compensation Point 3 Position", "String", "mdi:flash", battery_address=battery_address, sensor_prefix=sensor_prefix, entry_id=entry_id, is_settings=True),
        SeplosBMSSensorBase(coordinator, connector_info, "compensation_point_3_impedance", "Compensation Point 3 Impedance", "mΩ", "mdi:flash-alert", battery_address=battery_address, sensor_prefix=sensor_prefix, entry_id=entry_id, is_settings=True),
        SeplosBMSSensorBase(coordinator, connector_info, "compensation_point_4_position", "Compensation Point 4 Position", "String", "mdi:flash", battery_address=battery_address, sensor_prefix=sensor_prefix, entry_id=entry_id, is_settings=True),
        SeplosBMSSensorBase(coordinator, connector_info, "compensation_point_4_impedance", "Compensation Point 4 Impedance", "mΩ", "mdi:flash-alert", battery_address=battery_address, sensor_prefix=sensor_prefix, entry_id=entry_id, is_settings=True),
        SeplosBMSSensorBase(coordinator, connector_info, "working_status", "Working Status", "When", "mdi:flash", battery_address=battery_address, sensor_prefix=sensor_prefix, entry_id=entry_id, is_settings=True),
        SeplosBMSSensorBase(coordinator, connector_info, "status_information", "Status Information", "When", "mdi:flash", battery_address=battery_address, sensor_prefix=sensor_prefix, entry_id=entry_id, is_settings=True),
        SeplosBMSSensorBase(coordinator, connector_info, "equipment_version", "Equipment Version", "Version", "mdi:information-outline", battery_address=battery_address, sensor_prefix=sensor_prefix, entry_id=entry_id, is_settings=True),
    ]
