...
async def generate_sensors(hass, bms_type, port, config_battery_address, sensor_prefix, entry, async_add_entities):
    ...
    setting_sensors = [
        ...
        SeplosBMSSensorBase(coordinator, port, "total_pressure_low_pressure_recovery", "Total Pressure Low Pressure Recovery", "V", "mdi:flash-circle", battery_address=battery_address, sensor_prefix=sensor_prefix),
        ...
        SeplosBMSSensorBase(coordinator, port, "environmental_over_temperature_protection", "Environmental Over Temperature Protection", "°C", "mdi:thermometer-alert", battery_address=battery_address, sensor_prefix=sensor_prefix),
        SeplosBMSSensorBase(coordinator, port, "environmental_overtemperature_recovery", "Environmental Over Temperature Recovery", "°C", "mdi:thermometer", battery_address=battery_address, sensor_prefix=sensor_prefix),
        SeplosBMSSensorBase(coordinator, port, "environmental_under_temperature_protection", "Environmental Under Temperature Protection", "°C", "mdi:thermometer-alert", battery_address=battery_address, sensor_prefix=sensor_prefix),
        SeplosBMSSensorBase(coordinator, port, "environmental_undertemperature_recovery", "Environmental Undertemperature Recovery", "°C", "mdi:thermometer", battery_address=battery_address, sensor_prefix=sensor_prefix),
        SeplosBMSSensorBase(coordinator, port, "power_high_temperature_alarm", "Power High Temperature Alarm", "°C", "mdi:thermometer-alert", battery_address=battery_address, sensor_prefix=sensor_prefix),
        ...
        SeplosBMSSensorBase(coordinator, port, "charging_overcurrent_warning", "Charging Overcurrent Warning", "A", "mdi:flash-alert", battery_address=battery_address, sensor_prefix=sensor_prefix),
        SeplosBMSSensorBase(coordinator, port, "charging_overcurrent_recovery", "Charging Overcurrent Recovery", "A", "mdi:flash", battery_address=battery_address, sensor_prefix=sensor_prefix),
        SeplosBMSSensorBase(coordinator, port, "discharge_overcurrent_warning", "Discharge Overcurrent Warning", "A", "mdi:flash-alert", battery_address=battery_address, sensor_prefix=sensor_prefix),
        SeplosBMSSensorBase(coordinator, port, "discharge_overcurrent_recovery", "Discharge Overcurrent Recovery", "A", "mdi:flash", battery_address=battery_address, sensor_prefix=sensor_prefix),
        SeplosBMSSensorBase(coordinator, port, "charge_overcurrent_protection", "Charge Overcurrent Protection", "A", "mdi:flash-alert", battery_address=battery_address, sensor_prefix=sensor_prefix),
        SeplosBMSSensorBase(coordinator, port, "discharge_overcurrent_protection", "Discharge Overcurrent Protection", "A", "mdi:flash-alert", battery_address=battery_address, sensor_prefix=sensor_prefix),
        ...
        SeplosBMSSensorBase(coordinator, port, "overcurrent_delay_recovery", "Overcurrent Delay Recovery", "s", "mdi:timer-outline", battery_address=battery_address, sensor_prefix=sensor_prefix),
        SeplosBMSSensorBase(coordinator, port, "overcurrent_recovery_times", "Overcurrent Recovery Times", "", "mdi:counter", battery_address=battery_address, sensor_prefix=sensor_prefix),
        SeplosBMSSensorBase(coordinator, port, "charge_current_limit_delay", "Charge Current Limit Delay", "s", "mdi:timer-outline", battery_address=battery_address, sensor_prefix=sensor_prefix),
        SeplosBMSSensorBase(coordinator, port, "charge_activation_delay", "Charge Activation Delay", "s", "mdi:timer-outline", battery_address=battery_address, sensor_prefix=sensor_prefix),
        SeplosBMSSensorBase(coordinator, port, "charging_activation_interval", "Charging Activation Interval", "s", "mdi:timer-outline", battery_address=battery_address, sensor_prefix=sensor_prefix),
        SeplosBMSSensorBase(coordinator, port, "charge_activation_times", "Charge Activation Times", "", "mdi:counter", battery_address=battery_address, sensor_prefix=sensor_prefix),
        SeplosBMSSensorBase(coordinator, port, "work_record_interval", "Work Record Interval", "s", "mdi:timer-outline", battery_address=battery_address, sensor_prefix=sensor_prefix),
        SeplosBMSSensorBase(coordinator, port, "standby_recording_interval", "Standby Recording Interval", "s", "mdi:timer-outline", battery_address=battery_address, sensor_prefix=sensor_prefix),
        SeplosBMSSensorBase(coordinator, port, "standby_shutdown_delay", "Standby Shutdown Delay", "s", "mdi:timer-outline", battery_address=battery_address, sensor_prefix=sensor_prefix),
        SeplosBMSSensorBase(coordinator, port, "remaining_capacity_alarm", "Remaining Capacity Alarm", "Ah", "mdi:gauge", battery_address=battery_address, sensor_prefix=sensor_prefix),
        SeplosBMSSensorBase(coordinator, port, "remaining_capacity_protection", "Remaining Capacity Protection", "Ah", "mdi:gauge", battery_address=battery_address, sensor_prefix=sensor_prefix),
        SeplosBMSSensorBase(coordinator, port, "interval_charge_capacity", "Interval Charge Capacity", "Ah", "mdi:gauge", battery_address=battery_address, sensor_prefix=sensor_prefix),
        SeplosBMSSensorBase(coordinator, port, "cycle_cumulative_capacity", "Cycle Cumulative Capacity", "Ah", "mdi:gauge", battery_address=battery_address, sensor_prefix=sensor_prefix),
        SeplosBMSSensorBase(coordinator, port, "connection_fault_impedance", "Connection Fault Impedance", "", "mdi:resistor", battery_address=battery_address, sensor_prefix=sensor_prefix),
        SeplosBMSSensorBase(coordinator, port, "compensation_point_1_position", "Compensation Point 1 Position", "", "mdi:arrow-up", battery_address=battery_address, sensor_prefix=sensor_prefix),
        SeplosBMSSensorBase(coordinator, port, "compensation_point_1_impedance", "Compensation Point 1 Impedance", "", "mdi:resistor", battery_address=battery_address, sensor_prefix=sensor_prefix),
        SeplosBMSSensorBase(coordinator, port, "compensation_point_2_position", "Compensation Point 2 Position", "", "mdi:arrow-down", battery_address=battery_address, sensor_prefix=sensor_prefix),
        SeplosBMSSensorBase(coordinator, port, "compensation_point_2_impedance", "Compensation Point 2 Impedance", "", "mdi:resistor", battery_address=battery_address, sensor_prefix=sensor_prefix),
        SeplosBMSSensorBase(coordinator, port, "static_equilibrium_time", "Static Equilibrium Time", "s", "mdi:timer", battery_address=battery_address, sensor_prefix=sensor_prefix),
        SeplosBMSSensorBase(coordinator, port, "battery_number_in_series", "Battery Number in Series", "", "mdi:battery", battery_address=battery_address, sensor_prefix=sensor_prefix),
        SeplosBMSSensorBase(coordinator, port, "charge_overcurrent_delay", "Charge Overcurrent Delay", "ms", "mdi:timer", battery_address=battery_address, sensor_prefix=sensor_prefix),
        SeplosBMSSensorBase(coordinator, port, "discharge_overcurrent_delay", "Discharge Overcurrent Delay", "ms", "mdi:timer", battery_address=battery_address, sensor_prefix=sensor_prefix),
        ...
        SeplosBMSSensorBase(coordinator, port, "overcurrent_delay_recovery", "Overcurrent Delay Recovery", "ms", "mdi:timer", battery_address=battery_address, sensor_prefix=sensor_prefix),
        SeplosBMSSensorBase(coordinator, port, "overcurrent_recovery_times", "Overcurrent Recovery Times", "", "mdi:counter", battery_address=battery_address, sensor_prefix=sensor_prefix),
        SeplosBMSSensorBase(coordinator, port, "charge_current_limit_delay", "Charge Current Limit Delay", "ms", "mdi:timer", battery_address=battery_address, sensor_prefix=sensor_prefix),
        SeplosBMSSensorBase(coordinator, port, "charge_activation_delay", "Charge Activation Delay", "ms", "mdi:timer", battery_address=battery_address, sensor_prefix=sensor_prefix),
        SeplosBMSSensorBase(coordinator, port, "charging_activation_interval", "Charging Activation Interval", "ms", "mdi:timer", battery_address=battery_address, sensor_prefix=sensor_prefix),
        SeplosBMSSensorBase(coordinator, port, "charge_activation_times", "Charge Activation Times", "", "mdi:counter", battery_address=battery_address, sensor_prefix=sensor_prefix),
        SeplosBMSSensorBase(coordinator, port, "work_record_interval", "Work Record Interval", "ms", "mdi:timer", battery_address=battery_address, sensor_prefix=sensor_prefix),
        SeplosBMSSensorBase(coordinator, port, "standby_recording_interval", "Standby Recording Interval", "ms", "mdi:timer", battery_address=battery_address, sensor_prefix=sensor_prefix),
        SeplosBMSSensorBase(coordinator, port, "standby_shutdown_delay", "Standby Shutdown Delay", "s", "mdi:timer", battery_address=battery_address, sensor_prefix=sensor_prefix),
        SeplosBMSSensorBase(coordinator, port, "remaining_capacity_alarm", "Remaining Capacity Alarm", "%", "mdi:gauge", battery_address=battery_address, sensor_prefix=sensor_prefix),
        SeplosBMSSensorBase(coordinator, port, "remaining_capacity_protection", "Remaining Capacity Protection", "%", "mdi:gauge", battery_address=battery_address, sensor_prefix=sensor_prefix),
        SeplosBMSSensorBase(coordinator, port, "interval_charge_capacity", "Interval Charge Capacity", "%", "mdi:gauge", battery_address=battery_address, sensor_prefix=sensor_prefix),
        SeplosBMSSensorBase(coordinator, port, "cycle_cumulative_capacity", "Cycle Cumulative Capacity", "%", "mdi:gauge", battery_address=battery_address, sensor_prefix=sensor_prefix),
        SeplosBMSSensorBase(coordinator, port, "connection_fault_impedance", "Connection Fault Impedance", "", "mdi:resistor", battery_address=battery_address, sensor_prefix=sensor_prefix),
        SeplosBMSSensorBase(coordinator, port, "compensation_point_1_position", "Compensation Point 1 Position", "", "mdi:map-marker", battery_address=battery_address, sensor_prefix=sensor_prefix),
        SeplosBMSSensorBase(coordinator, port, "compensation_point_1_impedance", "Compensation Point 1 Impedance", "", "mdi:resistor", battery_address=battery_address, sensor_prefix=sensor_prefix),
        SeplosBMSSensorBase(coordinator, port, "compensation_point_2_position", "Compensation Point 2 Position", "", "mdi:map-marker", battery_address=battery_address, sensor_prefix=sensor_prefix),
        SeplosBMSSensorBase(coordinator, port, "compensation_point_2_impedance", "Compensation Point 2 Impedance", "", "mdi:resistor", battery_address=battery_address, sensor_prefix=sensor_prefix),
    ]
